...
export const ITEMS = {
  ...
  warhammer:    { name:'Kriegshammer', slot:'weapon', wtype:'hammer', dmg:24, reach:44, arc:1.4, speed:1150, stam:20, ap:0.6, stagger:2.0, crush:true, rarity:'rare', value:240, skill:'twohanded', twohand:true,
                  lore:'Gegen Platte gemacht. Kein Schild hält ihn, kein Getroffener bleibt stehen, wie er stand.' },
  halberd:      { name:'Hellebarde', slot:'weapon', wtype:'polearm', dmg:17, reach:82, arc:1.3, speed:920, stam:14, ap:0.3, sweep:true, rarity:'rare', value:210, skill:'polearms', twohand:true,
                  lore:'Beil, Haken und Spitze an einem Schaft. Die Spitze trifft, der Schaft nur halb — Abstand ist alles.' },
  crossbow:     { name:'Armbrust', slot:'weapon', wtype:'crossbow', dmg:26, reach:420, speed:420, reload:1900, stam:6, ap:0.5, rarity:'uncommon', value:170, skill:'archery', ranged:true, twohand:true,
                  lore:'Kein Spannen, kein Zielen im Wind: abdrücken. Dann dauert es, bis sie wieder gespannt ist.' },
  wand:         { name:'Zauberstab', slot:'weapon', wtype:'wand', dmg:7, reach:320, speed:460, stam:2, manaShot:4, rarity:'uncommon', value:160, skill:'unarmed', ranged:true, spell:true,
                  lore:'Kurz genug für eine Hand. Jeder Funke kostet ein wenig von dir.' },
...
export const CLASSES = {
  ...
  assassin:  { name:'Assassine', tier:2, parent:'rogue', abilities:['backstab','shadowstep'], desc:'Nicht da sein, dann dort.',
               weak:'Schattenschritt geht nicht in Ketten- oder Plattenpanzer.' },
  bard:      { name:'Barde', tier:1, parent:'wanderer', abilities:['war_song','discord'], desc:'Ein Lied trägt weiter als ein Schwert.',
               weak:'Eigener Waffenschaden −15 %: der Barde kämpft durch andere.' },
  alchemist: { name:'Alchemist', tier:1, parent:'wanderer', abilities:['fire_flask','poison_coat','brew'], desc:'Kraut, Feuer und Geduld.',
               weak:'Jede Fähigkeit kostet Heilkraut — ohne Kraut bleibt nur die Klinge.' },
};
...
export const ABILITIES = {
  ...
  war_song:    { name:'Kriegslied', cd:22000, stam:12, desc:'12 s für dich und die Gruppe: Schaden +15 %, Ausdauer kehrt 50 % schneller.' },
  discord:     { name:'Missklang', cd:14000, stam:14, desc:'Gegner im Umkreis (140 px) taumeln und schlagen 3 s lang oft daneben.' },
  fire_flask:  { name:'Feuerflasche', cd:6000, herb:2, desc:'Wirft eine Flasche zur Maus: Feuer im Umkreis. Kostet 2 Heilkraut.' },
  poison_coat: { name:'Giftöl', cd:20000, herb:1, desc:'20 s: jeder Treffer vergiftet (4 Schaden/s, 5 s). Kostet 1 Heilkraut.' },
  brew:        { name:'Trank brauen', cd:30000, herb:3, desc:'Braut aus 3 Heilkraut einen Heiltrank.' },
  // aktive Talentknoten (Skill-Baum, Session 7)
  war_cry:     { name:'Kampfschrei', cd:16000, stam:10, tree:true, desc:'Gegner im Umkreis (120 px) taumeln kurz und richten 6 s lang 20 % weniger Schaden an.' },
  blink:       { name:'Blinzeln', cd:9000, mana:12, tree:true, desc:'Ein Sprung von 110 px in Blickrichtung (nicht durch Mauern). Braucht Mana.' },
...
export const SKILL_TREE = {
  ...
  c_cry:    { branch:'combat', row:2, type:'active', name:'Kampfschrei', grants:'war_cry', fx:{}, requires:['c_breath'], desc:'Aktiv: Kampfschrei (Gegner taumeln, schlagen schwächer).' },
  ...
  m_blink:  { branch:'magic', row:2, type:'active', name:'Blinzeln', grants:'blink', fx:{}, requires:['m_quick'], desc:'Aktiv: Blinzeln (kurzer Sprung, Mana).' },
  ...
  s_aid:    { branch:'survival', row:2, type:'active', name:'Feldverband', grants:'first_aid', fx:{}, requires:['s_medic'], desc:'Aktiv: Feldverband (sofort 15 % Leben, stillt Blutung).' },
...
export const NPCS = [
  ...
  { key:'gerold', name:'Gerold', prof:'Kontorhändler', faction:'merch', age:51, home:'northcity',
    ...
    pool:['bread','dried_meat','potion','bandage','rapier','rapier','crossbow','longbow','shortbow','traveler_cloak','leather_jerkin','wand'],
  ...
  { key:'kelan', name:'Kelan der Graue', prof:'Alter Paladin', faction:'order', age:61, home:'shrine',
    ...
    greet:'„Ein Schwert macht dich nicht zum Ritter. Was du beschützt, tut es.“', teaches:['knight','paladin'] },
  ...
  { key:'brann', name:'Brann', prof:'Meisterschmiedin', faction:'valen', age:44, home:'northsmith',
    ...
    pool:['longsword','greatsword','mace','warhammer','halberd','axe','greataxe','spear','chain_hauberk','iron_helm','kite_shield','buckler'],
  ...
  { key:'oda', name:'Oda', prof:'Hauptfrau der Grenzwacht', faction:'valen', age:39, home:'grenzwacht',
    traits:['diszipliniert','mürrisch'], attrs:{strength:13,endurance:13}, cls:'warrior', recruit:false, shop:true, town:'grenzwacht',
    pool:['bandage','bandage','potion','dried_meat','bread','spear','crossbow','halberd','chain_hauberk','wooden_shield','iron_helm'],
    greet:'„Wer hierherkommt, hat sich verlaufen oder wurde strafversetzt. Welches von beiden?“', teaches:['berserker'] },
  { key:'lioba', name:'Lioba', prof:'Spielfrau', faction:'merch', age:31, home:'kreuzweg_tav',
    traits:['neugierig','gütig'], attrs:{charisma:15,agility:12}, cls:'wanderer', recruit:true, recruitRel:30,
    greet:'„Ein Lied? Kostet nichts. Zwei Lieder? Kostet ein Bier. Das Lied, das dir zeigt, wie man eine Schlacht dreht — kostet mehr.“', teaches:['bard'] },
  { key:'quirin', name:'Quirin', prof:'Alchemist', faction:'merch', age:58, home:'saltport_lab',
    traits:['genau','mürrisch'], attrs:{intelligence:15}, cls:'wanderer', recruit:false, shop:true, town:'saltport', market:false,
    pool:['potion','potion','potion','bandage','herb','herb','soul_vial'],
...
export const QUESTS = {
  ...
  q_frontier: { name:'Die Zahl der Toten', giver:'oda', desc:'Mein Späher ist vor drei Tagen zum Hundertfeld raus, südlich von hier. Er kommt nicht zurück — die kommen nie zurück. Aber seine Tasche will ich. Und wenn du schon da bist: leg ein paar von denen um, die dort aufstehen.',
    objectives:[{type:'item',target:'scout_report',count:1,text:'Tasche des Spähers vom Hundertfeld'}, {type:'kill',target:'skeleton',count:5,text:'Tote vom Hundertfeld'}],
    reward:{gold:80,xp:160,rep:{valen:8},take:'scout_report'}, turnin:'oda' },
